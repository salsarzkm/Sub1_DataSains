...
**Catatan: Tidak menggunakan Metabase dalam projek ini**
...
![Korelasi Fitur dengan Attrition]("CorrelationOfFeaturesWithAttrition.png")
...
![Attrition Rate By Dummy Variabel]("AttritionRateByDummyVariables.png")
